...
<%
 ...
 <div class="dashboard">
         ...
         <div class="profile-text">
             <p>
                <a href="About.jsp?employee_id=<%=employee_id%>">About</a><br>
                <a href="view_current.jsp">Current Projects</a><br>
                <a href="view_request.jsp">Requested Projects</a><br>
                <a href="view_rating.jsp">Reviews & Ratings</a> 
             </p>
