...
<div class="top">
        <div class="signin">
            ...
            <input type="email" name="email" required class="input_email" placeholder="   Email"/> 
            <input type="password" name="password" required class="input_password" placeholder="   password"/>
            <input type="submit" class="submitbtn" value="Sign in"/>
            </form>
            <p>Dont have an account? <a href="http://localhost:8088/Bootathon2/employee_signup.jsp">Sign up</a></p>
     ...
     <script type="text/javascript">
      ...
      window.location.href = "http://localhost:8088/Bootathon2/checklogin.jsp?email="+email+"&name="+name+"&id="+id;
   }
  </script>
